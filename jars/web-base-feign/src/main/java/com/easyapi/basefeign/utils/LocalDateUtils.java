package com.easyapi.basefeign.utils;
...
public class LocalDateUtils {
     ...
     * 年月日时
     */
    public final static String DEFAULT_PATTERN_DATE_HOUR = "yyyyMMddHH";
     ...
     * 年月日
     */
    public final static String DEFAULT_PATTERN_DATETIME_YEARMONTH = "yyyyMM";
     ...
     * 年月日时分
     */
    public final static String DEFAULT_PATTERN_DATETIME_MINTE = "yyyyMMddHHmm";
    ...
    public static String formatterLocalDateTimeToString(LocalDateTime localDateTime) {
        DateTimeFormatter dateTimeFormatter = getDateTimeFormatter(DEFAULT_PATTERN_DATETIME_DATE);
     ...
     * @return 开始时间
     */
    public static LocalDateTime getDayEndTime(int day) {
        return LocalDate.now().plusDays(day).atStartOfDay().withHour(23).withMinute(59).withSecond(59);
     ...
     * @return 两个时间相差多少秒
     */
    public static long differenceDateSeconds(LocalDateTime startTime,
                                            LocalDateTime endTime
    ) {
     ...
     * @return 返回指定日期的时间
     */
    public static LocalDateTime getLastDayFromMonth(LocalDateTime localDateTime) {
     ...
     * 获取当天某个小时的开始时间
     *
     * @param day 0 当前  1 未来一个小时 -1 过去一个小时
     * @param hour
     * @return 开始时间
     */
    public static LocalDateTime getHourStartTime(int day,int hour) {
        return LocalDateTime.now().plusDays(day).plusHours(hour).withMinute(0).withSecond(0);
    }
     ...
     * @return 开始时间
     */
    public static LocalDateTime getHourEndTime(int day,int hour) {
        return LocalDateTime.now().plusDays(day).plusHours(hour).withMinute(59).withSecond(59);
    }
     ...
     * @return 增加或减少后的日期
     */
    public static Integer getDays(int day) {
        LocalDateTime beforeDay= addDay(Instant.now(), day);
        String beforDateFormatter = formatterLocalDateTimeToString(beforeDay, DEFAULT_PATTERN_DATETIME_DATE);
        Integer beforeDate = Integer.valueOf(beforDateFormatter);
        return beforeDate;
    }
